...
struct Landmark: Decodable, Identifiable {
    ...
    var imageURL: URL {
        URL(string: "http://localhost:8080/landmarks/\(imageName)@2x.jpg")!
    }
...
extension Landmark {
    static let sampleLandmarks = [
        ...
        Landmark(
            ...
            coordinates: .init(latitude: -152.665167, longitude: 59.980167)
        ),
        Landmark(
            id: 1003,
            name: "Chilkoot Trail",
            ...
            coordinates: .init(latitude: 59.560551, longitude: -135.33457)
        )
    ]
}
